	...
	var Gitment = function() {
			_createClass(Gitment, [{
				...
				get: function get() {
					...
					var redirect_uri = this.oauth.redirect_uri || window.location.href.replace('https', 'http');
